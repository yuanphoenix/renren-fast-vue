...
export default {
  ...
  methods: {
    mergeItem() {
      ...
      if (!this.purchaseId) {
        this.$confirm(
          ...
          .then(() => {
            this.$http({
              url: this.$http.gulimalladornUrl("/ware/purchase/merge"),
              method: "post",
    ...
    getUnreceivedPurchase() {
      this.$http({
        url: this.$http.gulimalladornUrl("/ware/purchase/unreceive/list"),
        method: "get",
        params: this.$http.adornParams({})
      }).then(({ data }) => {
        this.purchasetableData = data.page.records;
      });
    },
    ...
    getWares() {
      this.$http({
        url: this.$http.gulimalladornUrl("/ware/wareinfo/list"),
        method: "get",
        params: this.$http.adornParams({
          page: 1,
          limit: 500
        ...
        this.wareList = data.page.records;
      });
    },
    // 获取数据列表
    getDataList() {
      ...
      this.$http({
        url: this.$http.gulimalladornUrl("/ware/purchasedetail/list"),
        method: "get",
        params: this.$http.adornParams({
          page: this.pageIndex,
          limit: this.pageSize,
    ...
    deleteHandle(id) {
      ...
      this.$confirm(
        ...
        this.$http({
          url: this.$http.gulimalladornUrl("/ware/purchasedetail/delete"),
          method: "post",
